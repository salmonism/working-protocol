const works = [
  {id:1,title:"두 사람 Twins",year:"2024",medium:"Oil on Linen canvas",dimensions:"90.9x65.1cm",description:"도시에 덩그러니 놓여진 화분 둘. 콘크리트 아래에서 서로 의지하며 서 있는 두 사람.",vimeo:"https://vimeo.com/1214897410?share=copy&fl=sv&fe=ci",image:"assets/works/work-01-2.jpg",x:6.64,y:16.62,w:12.01,h:29.89},
  {id:2,title:"이파리 Ipari",year:"2022",medium:"Gouache on paper",dimensions:"57.5x76cm",description:"산책길에 발견한 이파리들을 계절이 바뀔 때마다 관찰하며 사진으로 담았었다. 그 모습을 보면서 서로 비슷해 보이지만 각자만의 삶을 살아가는 사람들을 떠올렸다. 이파리 하나 하나의 색을 다르게 표현했는데, 이파리 하나가 하나가 개별의 삶이라는 것을 드러내며, 그들이 가진 고유성을 살리고 싶었다.",vimeo:"VIMEO_LINK_02",image:"assets/works/work-02-2.jpg",x:21.34,y:22.46,w:16.06,h:23.08},
  ...
  {id:4,title:"달잡이 Lyric City, Dal",year:"2024",medium:"Acrylic on Linen Canvas",dimensions:"65.1x53cm ",description:"우리들은 저 달을 마치 잡을 수 있는 것처럼 뻗고 또 뻗었다.",vimeo:"VIMEO_LINK_04",image:"assets/works/work-04-2.jpg",x:52.15,y:22.99,w:8.74,h:22.99},
  {id:5,title:"그녀들의 계절",year:"2026",medium:"Oil on Canvas",dimensions:"45.5x91cm",description:"당신의 찬란한 시간들.",vimeo:"VIMEO_LINK_05",image:"assets/works/work-05-2.jpg",x:62.16,y:23.70,w:17.33,h:18.57},
  ...
  {id:7,title:"비올레타의 방",year:"2025",medium:"Oil on Linen canvas",dimensions:"65.1x53cm",description:"클라우디아에게 꽃을 선물받은 비올레타는 방에다가 소중하게 꽂아두었다.",vimeo:"VIMEO_LINK_07",image:"assets/works/work-07-2.jpg",x:7.08,y:49.34,w:10.35,h:23.70},
